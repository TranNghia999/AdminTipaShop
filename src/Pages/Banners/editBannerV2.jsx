...
const EditBannerV2 = () => {
  ...
  const handleSubmit = (e) => {
    ...
    editData( `/api/bannerV2/${context?.isOpenFullScreenPanel?.id}`,
      formFields
    ).then((res) => {
      setTimeout(() => {
        setIsLoading(false);
        ...
        <div className="scroll max-h-[72vh] overflow-y-scroll pr-4 pt-4">
          <div className="grid grid-cols-1 sm:grid-cols-5 md:grid-cols-5 lg:grid-cols-5 mb-3 gap-5">
            ...
            <div className="col w-full">
              <h3 className="text-[15px] font-[500] mb-1 text-black">
                Danh Mục Chính
              </h3>
          ...
          <h3 className="text-[16px] font-[600] mb-3 text-black">
           Hình Ảnh Banner <span className='text-[12px] font-[400]'>( W:768 * H:447 )</span>
          </h3>
