...
const columns = [
  { id: "image", label: "HÌNH ẢNH", minWidth: 250 },
  { id: "action", label: "CHỨC NĂNG", minWidth: 150 },
];
 ...
 // Code xóa bỏ sản phẩm
  ...
  return (
    <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 px-2 py-0 mt-1 md:mt-3">
