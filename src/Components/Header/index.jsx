...
const Header = () => {
  ...
  return (
    ...
    <header className={`w-full h-[auto] py-2 ${context.isSidebarOpen===true ? 'pl-64' : 'pl-5'}
                      ${context.isSidebarOpen===true && context?.windowWidth < 992 && '!pl-62'}
                      pr-7 bg-[#fff] shadow-md flex items-center justify-between transition-all fixed top-0 left-0 z-[30]`}>
        <div className='part1'>
      ...
      <Dialog fullScreen
        ...
        <AppBar sx={{ position: 'relative' }}>
          ...
          {
            context?.isOpenFullScreenPanel?.model === 'Sửa Slider Trang Chủ' && <EditHomeSlide />
          }
